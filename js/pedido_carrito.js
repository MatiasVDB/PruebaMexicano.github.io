...
function ready() {
	...
	document
		.getElementsByClassName('botonBorrarPedidos')[0]
		.addEventListener('click', limpiarCarro);
}
...
function addItemToCart(title, price) {
	...
	cartRow
		.getElementsByClassName('inputCantidad')[0]
	...
	for (var i = 0; i < tam; i++) {
		...
		if (string == getTitle(cookie)) {
			document.cookie =
				...
				'; expires=Thu, 01 Jan 1970 00:00:00 UTC; Secure;';
			return 1;
		}
	}
	return 0;
...
function resetCookies() {
	...
	for (i = 0; i < tam; i++) {
		document.cookie =
			'plato' + get3D(i) + '=; expires=Thu, 01 Jan 1970 00:00:00 UTC; Secure;';
	}
}
